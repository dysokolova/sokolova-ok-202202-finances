...
include("finances-app-ktor")
include("finances-biz")
include("finances-app-rabbit")
include("finances-repo-inmemory")
include("finances-repo-test")
include("finances-repo-stub")
include("finances-repo-inmemory")
include("finances-storage-postgresql")
