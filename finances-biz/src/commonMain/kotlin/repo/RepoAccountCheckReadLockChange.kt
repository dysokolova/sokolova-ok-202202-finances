...
fun ICorChainDsl<FinsContext>.repoAccountCheckReadLockChange(title: String) = worker {
    this.title = title
    ...
    handle {
        FinsStubs.ERROR_ACCOUNT_CONCURENT_ON_CHANGE.getError(this.getText(FinsStubs.ERROR_ACCOUNT_CONCURENT_ON_CHANGE))?.let { this.fail(it) }
